...
gulp.task('styles', () => gulp.src('src/scss/main.scss')
...
gulp.task('layoutImg', () => gulp.src('src/layoutImg/**/*')
...
gulp.task('theme', () => gulp.src('src/theme/**/*')
...
gulp.task('sitemap', () => gulp.src('dest/wp-content/themes/corwave/**/*.html', {
    read: false,
})
    .pipe(sitemap({
